...
Similar to [promtail](https://github.com/grafana/loki/blob/main/docs/sources/clients/promtail/configuration.md#relabel_config) this config will follow native [Prometheus relabel-config](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config) syntax.
