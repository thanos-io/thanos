...
We want all docs to not have any white noise. To achieve it, we provide cleanup-white-noise.sh under `scripts` to check. You can call it before a pull request, also PR test would call it too.
