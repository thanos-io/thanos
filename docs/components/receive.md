...
As of version [v0.22.0](https://github.com/thanos-io/thanos/blob/main/CHANGELOG.md#added), the Thanos receiver implements the [receiver split proposal](../proposals-accepted/202012_receive_split.md), which allows data ingestion as well as request routing to be independently enabled/disabled.
