...
### List of Metrics Exported By Store Gateway
...
| thanos_store_selects_dropped_total           | counter   | Number of select queries that were dropped due to configured limits.                                                                                |
