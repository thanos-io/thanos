...
QueryAPI and StoreAPI has additional behaviour controlled via query parameter called [PartialResponseStrategy](https://github.com/thanos-io/thanos/blob/main/pkg/store/storepb/rpc.pb.go).
