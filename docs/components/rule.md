...
either gap in rule or potentially ignored alert. This metrics indicates an unhealthy downstream query component. Alert heavily on this if this happens for longer than your alert thresholds.
