...
If you choose to use the sidecar to also upload uncompacted prometheus blocks(for compacted blocks, see [Upload compacted blocks](./sidecar.md/#upload-compacted-blocks-experimental)) to object storage:
