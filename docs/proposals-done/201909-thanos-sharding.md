...
Similar to [promtail](https://grafana.com/docs/loki/v3.5.x/send-data/promtail/scraping/#relabeling) this config will follow native [Prometheus relabel-config](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config) syntax.
