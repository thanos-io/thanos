...
* [`HeadChunkID`](https://pkg.go.dev/github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/chunks#HeadChunkID) references a chunk of a `memSeries` (either an `mmappedChunk` or `headChunk`).
...
* [`ChunkDiskMapperRef`](https://pkg.go.dev/github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/chunks#ChunkDiskMapperRef) is an 8 Byte integer.
