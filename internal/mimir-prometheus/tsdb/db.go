...
import (
	...
	_ "github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/goversion" // Load the package into main to make sure minium Go version is met.
	"github.com/thanos-io/thanos/internal/mimir-prometheus/tsdb/hashcache"
