...
type PrometheusInstantQueryResult struct {
	...
	//	*PrometheusInstantQueryResult_Sample
	//	*PrometheusInstantQueryResult_Samples
...
type PrometheusInstantQueryResult_Sample struct {
	Sample *cortexpb.Sample `protobuf:"bytes,1,opt,name=sample,proto3,oneof" json:"sample,omitempty"`
}
type PrometheusInstantQueryResult_Samples struct {
	Samples *Vector `protobuf:"bytes,2,opt,name=samples,proto3,oneof" json:"samples,omitempty"`
}

func (*PrometheusInstantQueryResult_Sample) isPrometheusInstantQueryResult_Result()  {}
func (*PrometheusInstantQueryResult_Samples) isPrometheusInstantQueryResult_Result() {}
...
func (m *PrometheusInstantQueryResult) GetSample() *cortexpb.Sample {
	if x, ok := m.GetResult().(*PrometheusInstantQueryResult_Sample); ok {
		return x.Sample
	}
	return nil
}

func (m *PrometheusInstantQueryResult) GetSamples() *Vector {
	if x, ok := m.GetResult().(*PrometheusInstantQueryResult_Samples); ok {
		return x.Samples
	}
	return nil
}
...
func (*PrometheusInstantQueryResult) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PrometheusInstantQueryResult_Sample)(nil),
		(*PrometheusInstantQueryResult_Samples)(nil),
	}
}

type Vector struct {
	Result               []*Sample `protobuf:"bytes,1,rep,name=Result,proto3" json:"Result,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *Vector) GetResult() []*Sample {
	if m != nil {
		return m.Result
	}
	return nil
...
var fileDescriptor_9af7607b46ac39b7 = []byte{
	...
	,
}
...
func (m *PrometheusInstantQueryResult_Sample) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrometheusInstantQueryResult_Sample) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Sample != nil {
		{
...
func (m *PrometheusInstantQueryResult_Samples) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrometheusInstantQueryResult_Samples) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Samples != nil {
		{
...
func (m *PrometheusInstantQueryResult_Sample) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PrometheusInstantQueryResult_Samples) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PrometheusInstantQueryResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Result = &PrometheusInstantQueryResult_Sample{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Result = &PrometheusInstantQueryResult_Samples{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQueryrange(dAtA[iNdEx:])
...
func (m *Vector) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Result = append(m.Result, &Sample{})
			if err := m.Result[len(m.Result)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
