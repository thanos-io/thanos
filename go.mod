...
replace (
	...
	// Pointing to branch adjust-start-times, commit 35224884143f94f3ecd4db3505f8ea3ec452a1e9.
	github.com/thanos-community/promql-engine => github.com/fpetkovski/promql-engine v0.0.0-20230315083842-35224884143f
