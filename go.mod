...
replace (
	...
	// Pointing to branch adjust-start-times, commit 288056846738357ccb8a63472ccd378b2c44d15c.
	github.com/thanos-community/promql-engine => github.com/fpetkovski/promql-engine v0.0.0-20230314100317-288056846738
