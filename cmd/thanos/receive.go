...
func (rc *receiveConfig) registerFlag(cmd extkingpin.FlagClause) {
	...
	cmd.Flag("receive.split-tenant-label-name", "Label name through which the request will be split into multiple tenants.").Default("").StringVar(&rc.splitTenantLabelName)
