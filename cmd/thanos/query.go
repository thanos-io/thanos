...
func runQuery(
	...
	// Start query (proxy) gRPC StoreAPI.
	{
		...
		grpcAPI := apiv1.NewGRPCAPI(time.Now, queryReplicaLabels, queryableCreator, queryEngine, lookbackDeltaCreator, instantDefaultMaxSourceResolution, projectionAnalyzer)
