...
// durationValue implements the kingpin.Value interface for time.Duration.
...
// Inside the registerFlag method of sidecarConfig struct, register the flag with the duration value.
