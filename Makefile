...
check-docs: $(EMBEDMD) $(LICHE) build
	...
	@$(LICHE) --recursive docs --exclude "(cloud.baidu.com|cloud.tencent.com|alibabacloud.com)" --document-root .
	@$(LICHE) --exclude "(cloud.baidu.com|cloud.tencent.com|goreportcard.com|alibabacloud.com)" --document-root . *.md
