...
DIRS="store/storepb/ store/storepb/prompb/ store/labelpb rules/rulespb targets/targetspb store/hintspb queryfrontend objmeta/objmetapb metadata/metadatapb exemplars/exemplarspb info/infopb api/query/querypb"
