...
* [How to deploy the sidecar](components/sidecar.md#deployment)
...
* [How to deploy query nodes](components/query.md#deployment)
...
* [How to deploy store nodes](components/store.md#deployment)
...
* [How to deploy rule nodes](components/rule.md#deployment)
...
* [How to deploy the compactor](components/compact.md#deployment)
