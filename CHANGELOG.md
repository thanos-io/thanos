...
- [#6362](https://github.com/thanos-io/thanos/pull/6362) Query Frontend: Add flag `query-frontend.vertical-sharding-without-by` to enable vertical sharding for queries without by clause.
