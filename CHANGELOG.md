...
- [#5839](https://github.com/thanos-io/thanos/pull/5839) Receive: Add parameter `--tsdb.out-of-order-time-window` to set time window for experimental out-of-order samples ingestion. Disabled by default (set to 0s).
