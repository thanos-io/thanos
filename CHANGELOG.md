...
- [#8594](https://github.com/thanos-io/thanos/pull/8594): Query: Support per endpoint TLS configuration.
- [#8506](https://github.com/thanos-io/thanos/issues/8506): Bucket Web: Display block labels on each source row so users can identify sources without clicking into individual blocks.
