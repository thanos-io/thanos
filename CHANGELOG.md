...
- [#6876](https://github.com/thanos-io/thanos/issues/6876): UI: Display warnings on the targets page when some stores are unavailable and targets could not be fully loaded.
