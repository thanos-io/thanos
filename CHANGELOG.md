...
- [#9011](https://github.com/thanos-io/thanos/pull/9011): Query Frontend: Reject `lookback_delta` values that overflow int64 instead of silently dropping the parameter.
