...
- [#6174](https://github.com/thanos-io/thanos/pull/6174) Tools bucket replicate: Added a new flag `replicate-concurrency` which lets the user to choose the concurrency level for replicating blocks.
