...
- [#9024](https://github.com/thanos-io/thanos/pull/9024): UI: Restore the persisted state of the Query panel's "Use Partial Response" checkbox instead of forcing it back on.
