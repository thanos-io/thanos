...
=======
- [#6751](https://github.com/thanos-io/thanos/pull/6751) Query Frontend: Added TLS support in `--query-frontend.downstream-tripper-config` and `--query-frontend.downstream-tripper-config-file`
>>>>>>> fefffe47 (added the entry to changelog)
### Changed
