...
- `thanos rule` now supports file based discovery of query nodes using `--query.file-sd-config.addresses`
- `thanos query` now supports file based discovery of store nodes using `store.file-sd-config.addresses`
