...
- [#1762](https://github.com/thanos-io/thanos/pull/1762) Add `--web.web.external-prefix` and `--web.web.prefix-header` flags to allow for bucket UI to be accessible behind a reverse proxy.
