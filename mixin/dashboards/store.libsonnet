  ...
  grafanaDashboards+:: {
    ...
    __overviewRows__+:: [
      ...
      .addPanel(
        ...
        g.grpcRequestsPanel('grpc_server_handled_total', 'namespace="$namespace",%(selector)s,grpc_type="unary"' % thanos.store) +
      ...
      .addPanel(
        ...
        g.grpcErrorsPanel('grpc_server_handled_total', 'namespace="$namespace",%(selector)s,grpc_type="unary"' % thanos.store) +
        g.addDashboardLink(thanos.store.title)
      )
      .addPanel(
        g.sloLatency(
