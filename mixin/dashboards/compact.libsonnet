  ...
  grafanaDashboards+:: {
    [if thanos.compact != null then 'compact.json']:
      ...
      .addRow(
        ...
        .addPanel(
          g.timeseriesPanel('Errors', 'Shows ratio of errors compared to the total number of executed downsampling against blocks that are stored in the bucket.') +
          g.qpsErrTotalPanel(
      ...
      .addRow(
        ...
        .addPanel(
          g.timeseriesPanel('Errors', 'Shows ratio of errors compared to the total number of executed garbage collections.') +
          g.qpsErrTotalPanel(
        ...
        .addPanel(
          g.timeseriesPanel('Duration', 'Shows how long has it taken to execute garbage collection in quantiles.') +
      ...
      .addRow(
        ...
        .addPanel(
          g.timeseriesPanel('Errors', 'Shows ratio of errors compared to the total number of executed meta file sync.') +
          g.qpsErrTotalPanel(
        ...
        .addPanel(
          g.timeseriesPanel('Duration', 'Shows how long has it taken to execute meta file sync, in quantiles.') +
