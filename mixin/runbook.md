...
|ThanosStoreObjstoreOperationBlocksMissing|During the last 6 hours, Thanos Store could not upload a single block.|Thanos Store {{$labels.job}}%s Bucket could not upload a single block during the last {{$value}} seconds|warning|[https://github.com/thanos-io/thanos/tree/main/mixin/runbook.md#alert-name-thanosstoreobjstoreoperationblocksmissing](https://github.com/thanos-io/thanos/tree/main/mixin/runbook.md#alert-name-thanosstoreobjstoreoperationblocksmissing)|
