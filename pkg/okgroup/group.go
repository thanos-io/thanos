...
//
// This file was copied from https://github.com/oklog/oklog/blob/master/pkg/group/group.go and modified.
package okgroup
...
// Add another Group's actors (functions) to the group.
func (g *Group) AddGroup(group Group) {
	g.actors = append(g.actors, group.actors...)
}
