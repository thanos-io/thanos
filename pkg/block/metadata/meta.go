...
const (
	// MetaVersion is a enumeration of TSDB meta versions supported by Thanos.
	TSDBVersion1 = iota + 1
)
...
type Thanos struct {
	// Version of Thanos meta file. If none specified, 1 is assumed (since first version did not have explicit version
	// specified).
