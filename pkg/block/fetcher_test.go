...
func TestConsistencyDelayMetaFilter_Filter_0(t *testing.T) {
	...
	input := map[ulid.ULID]*metadata.Meta{
		...
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now.Add(-1 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.RulerSource, LastModified: now.Add(-1 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.ReceiveSource, LastModified: now.Add(-1 * time.Minute)}},
		// If lastModified time is set, ignore the time from block ID.
		u.ULID(now.Add(-10 * time.Hour)): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now}},

		// For now non-delay delete sources, should be ignored by consistency delay.
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorSource, LastModified: now.Add(-1 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorRepairSource, LastModified: now.Add(-1 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.BucketRepairSource, LastModified: now.Add(-1 * time.Minute)}},

		// 29m.
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now.Add(-29 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.RulerSource, LastModified: now.Add(-29 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.ReceiveSource, LastModified: now.Add(-29 * time.Minute)}},

		// For now non-delay delete sources, should be ignored by consistency delay.
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorSource, LastModified: now.Add(-29 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorRepairSource, LastModified: now.Add(-29 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.BucketRepairSource, LastModified: now.Add(-29 * time.Minute)}},

		// 30m.
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now.Add(-30 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.RulerSource, LastModified: now.Add(-30 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.ReceiveSource, LastModified: now.Add(-30 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorSource, LastModified: now.Add(-30 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorRepairSource, LastModified: now.Add(-30 * time.Minute)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.BucketRepairSource, LastModified: now.Add(-30 * time.Minute)}},

		// 30m+.
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.SidecarSource, LastModified: now.Add(-2 * time.Hour)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.RulerSource, LastModified: now.Add(-2 * time.Hour)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.ReceiveSource, LastModified: now.Add(-2 * time.Hour)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorSource, LastModified: now.Add(-2 * time.Hour)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.CompactorRepairSource, LastModified: now.Add(-2 * time.Hour)}},
		u.ULID(now): {Thanos: metadata.Thanos{Source: metadata.BucketRepairSource, LastModified: now.Add(-2 * time.Hour)}},
		// Fallback to block ID timestamp.
		u.ULID(now.Add(-2 * time.Hour)): {Thanos: metadata.Thanos{Source: metadata.BucketRepairSource}},
	}
