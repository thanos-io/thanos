...
func (m *CompressedLabel) Reset()         { *m = CompressedLabel{} }
func (m *CompressedLabel) String() string { return proto.CompactTextString(m) }
func (*CompressedLabel) ProtoMessage()    {}
func (*CompressedLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcc9e7dae4870e8, []int{1}
}
func (m *CompressedLabel) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CompressedLabel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CompressedLabel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CompressedLabel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompressedLabel.Merge(m, src)
}
func (m *CompressedLabel) XXX_Size() int {
	return m.Size()
}
func (m *CompressedLabel) XXX_DiscardUnknown() {
	xxx_messageInfo_CompressedLabel.DiscardUnknown(m)
}

var xxx_messageInfo_CompressedLabel proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CompressedLabel)(nil), "thanos.CompressedLabel")
...
var fileDescriptor_cdcc9e7dae4870e8 = []byte{
	...
	,
}
...
func (m *CompressedLabel) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CompressedLabel) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CompressedLabel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CompressedLabel) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CompressedLabel) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompressedLabel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompressedLabel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
