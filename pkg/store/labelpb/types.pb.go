...
type StringLabels struct {
	Data string `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}

func (m *StringLabels) Reset()         { *m = StringLabels{} }
func (m *StringLabels) String() string { return proto.CompactTextString(m) }
func (*StringLabels) ProtoMessage()    {}
func (*StringLabels) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdcc9e7dae4870e8, []int{1}
}
func (m *StringLabels) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StringLabels) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StringLabels.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StringLabels) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StringLabels.Merge(m, src)
}
func (m *StringLabels) XXX_Size() int {
	return m.Size()
}
func (m *StringLabels) XXX_DiscardUnknown() {
	xxx_messageInfo_StringLabels.DiscardUnknown(m)
}

var xxx_messageInfo_StringLabels proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*StringLabels)(nil), "thanos.StringLabels")
...
var fileDescriptor_cdcc9e7dae4870e8 = []byte{
	...
	,
}
...
func (m *StringLabels) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StringLabels) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringLabels) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StringLabels) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringLabels) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StringLabels: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StringLabels: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
