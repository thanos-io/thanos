...
func (m *SeriesRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Range != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Range))
		i--
		dAtA[i] = 0x58
	}
	if m.Step != 0 {
...
func (m *QueryHints) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.StepMillis != 0 {
		i = encodeVarint(dAtA, i, uint64(m.StepMillis))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Range) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Millis != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Millis))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
