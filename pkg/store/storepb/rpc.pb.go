...
import (
	...
	tracepb "github.com/thanos-io/thanos/pkg/store/tracepb"
...
type SeriesResponse_Trace struct {
	Trace *tracepb.Trace `protobuf:"bytes,4,opt,name=trace,proto3,oneof" json:"trace,omitempty"`
}
...
func (*SeriesResponse_Trace) isSeriesResponse_Result()   {}
...
func (m *SeriesResponse) GetTrace() *tracepb.Trace {
	if x, ok := m.GetResult().(*SeriesResponse_Trace); ok {
		return x.Trace
	}
	return nil
}
...
var fileDescriptor_a938d55a388af629 = []byte{
	...
	,
}
...
func (m *SeriesResponse_Trace) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SeriesResponse_Trace) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Trace != nil {
		{
...
func (m *SeriesResponse_Trace) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SeriesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Result = &SeriesResponse_Trace{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
