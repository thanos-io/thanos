...
type SeriesRequest struct {
	...
	// query_hints represents aggregations and grouping that are safe to pushdown
	// to be evaluated on server side if possible.
	QueryHints []QueryHints `protobuf:"bytes,12,rep,name=query_hints,json=queryHints,proto3" json:"query_hints"`
}
...
type QueryHints struct {
	...
	By    bool  `protobuf:"varint,4,opt,name=by,proto3" json:"by,omitempty"`
	Range int64 `protobuf:"varint,5,opt,name=range,proto3" json:"range,omitempty"`
}
...
var fileDescriptor_a938d55a388af629 = []byte{
	...
	,
}
...
func (m *SeriesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.QueryHints) > 0 {
		for iNdEx := len(m.QueryHints) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.QueryHints[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryHints) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Grouping) > 0 {
		for iNdEx := len(m.Grouping) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRpc(dAtA, i, uint64(len(m.Grouping[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *SeriesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			m.QueryHints = append(m.QueryHints, QueryHints{})
			if err := m.QueryHints[len(m.QueryHints)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
