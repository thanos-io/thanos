...
type SeriesRequest struct {
	...
	MinResolution int64          `protobuf:"varint,4,opt,name=min_resolution,json=minResolution,proto3" json:"min_resolution,omitempty"`
...
func (m *SeriesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MinResolution != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintRpc(dAtA, i, uint64(m.MinResolution))
	}
...
func (m *SeriesRequest) Size() (n int) {
	...
	if m.MinResolution != 0 {
		n += 1 + sovRpc(uint64(m.MinResolution))
	}
	if len(m.Aggregates) > 0 {
		l = 0
...
func (m *SeriesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinResolution", wireType)
			}
			m.MinResolution = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinResolution |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRpc = []byte{
	...
	,
}
