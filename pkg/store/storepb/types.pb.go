...
type CompressedSeries struct {
	Labels []labelpb.CompressedLabel `protobuf:"bytes,1,rep,name=labels,proto3" json:"labels"`
	Chunks []AggrChunk               `protobuf:"bytes,2,rep,name=chunks,proto3" json:"chunks"`
}

func (m *CompressedSeries) Reset()         { *m = CompressedSeries{} }
func (m *CompressedSeries) String() string { return proto.CompactTextString(m) }
func (*CompressedSeries) ProtoMessage()    {}
func (*CompressedSeries) Descriptor() ([]byte, []int) {
	return fileDescriptor_121fba57de02d8e0, []int{1}
}
func (m *CompressedSeries) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CompressedSeries) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CompressedSeries.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CompressedSeries) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompressedSeries.Merge(m, src)
}
func (m *CompressedSeries) XXX_Size() int {
	return m.Size()
}
func (m *CompressedSeries) XXX_DiscardUnknown() {
	xxx_messageInfo_CompressedSeries.DiscardUnknown(m)
}

var xxx_messageInfo_CompressedSeries proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CompressedSeries)(nil), "thanos.CompressedSeries")
...
var fileDescriptor_121fba57de02d8e0 = []byte{
	...
	,
}
...
func (m *CompressedSeries) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CompressedSeries) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CompressedSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CompressedSeries) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CompressedSeries) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompressedSeries: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompressedSeries: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Labels = append(m.Labels, labelpb.CompressedLabel{})
