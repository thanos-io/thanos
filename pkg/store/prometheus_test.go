...
func testPrometheusStoreSeriesE2e(t *testing.T, prefix string) {
	...
	limitMinT := int64(0)
	proxy, err := NewPrometheusStore(promclient.NewDefaultClient(), u, component.Sidecar,
...
func TestPrometheusStore_Info(t *testing.T) {
	...
	proxy, err := NewPrometheusStore(promclient.NewDefaultClient(), nil, component.Sidecar,
		func() labels.Labels { return labels.FromStrings("region", "eu-west") },
