	...
	for _, tcase := range []struct {
		...
		},
		{
			...
			exp: []series{
				{
					lset:    labels.FromStrings("a", "1"),
					samples: []sample{{10000, 8}, {20000, 9}, {45001, 9}, {55001, 10}, {65001, 11}, {80000, 13}, {90000, 14}, {100000, 15}},
				},
			},
		},
		{
			...
			exp: []series{
				{
					lset:    labels.FromStrings("a", "1"),
					samples: []sample{{10000, 8}, {20000, 9}, {45001, 8.5}, {55001, 9.5}, {65001, 10.5}, {80000, 13}, {90000, 14}, {100000, 15}},
				},
			},
		},
		{
