...
func TestOverlapSplitSet(t *testing.T) {
	input := []chunkedSeries{
		...
		},
		{
			...
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 20}, {MinTime: 21, MaxTime: 100}, {MinTime: 110, MaxTime: 300}},
		},
		{
			lset:   labels.FromStrings("a", "3_tworeplicas"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 20}, {MinTime: 0, MaxTime: 30}, {MinTime: 21, MaxTime: 50}, {MinTime: 31, MaxTime: 60}, {MinTime: 100, MaxTime: 160}},
		},
		{
			lset:   labels.FromStrings("a", "4_nonoverlap"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 50, MaxTime: 55}, {MinTime: 56, MaxTime: 100}},
		},
		{
			lset:   labels.FromStrings("a", "5_minimaloverlap"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 50, MaxTime: 55}, {MinTime: 55, MaxTime: 100}},
		},
		{
			lset: labels.FromStrings("a", "6_fourreplica"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 20}, {MinTime: 0, MaxTime: 30}, {MinTime: 1, MaxTime: 15}, {MinTime: 2, MaxTime: 36}, {MinTime: 16, MaxTime: 200},
	...
	exp := []chunkedSeries{
		...
		{
			lset:   labels.FromStrings("a", "3_tworeplicas"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 20}, {MinTime: 21, MaxTime: 50}, {MinTime: 100, MaxTime: 160}},
		},
		{
			lset:   labels.FromStrings("a", "3_tworeplicas"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 30}, {MinTime: 31, MaxTime: 60}},
		},
		{
			lset:   labels.FromStrings("a", "4_nonoverlap"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 50, MaxTime: 55}, {MinTime: 56, MaxTime: 100}},
		...
		{
			lset:   labels.FromStrings("a", "5_minimaloverlap"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 50, MaxTime: 55}},
		},
		{
			lset:   labels.FromStrings("a", "5_minimaloverlap"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 55, MaxTime: 100}},
		},
		{
			lset:   labels.FromStrings("a", "6_fourreplica"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 0, MaxTime: 20}, {MinTime: 21, MaxTime: 50}, {MinTime: 100, MaxTime: 160}},
		...
		{
			lset:   labels.FromStrings("a", "6_fourreplica"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 1, MaxTime: 15}, {MinTime: 16, MaxTime: 200}},
		},
		{
			lset:   labels.FromStrings("a", "6_fourreplica"),
			chunks: []*storepb.AggrChunk{&storepb.AggrChunk{MinTime: 2, MaxTime: 36}},
		},
	}
