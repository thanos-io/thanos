...
type InfoServer struct {
	...
	getLabelSet           func() []labels.Labels
...
func NewInfoServer(
	...
	srv := &InfoServer{
		...
		getLabelSet:           func() []labels.Labels { return nil },
...
func WithLabelSetFunc(getLabelSet ...func() []labels.Labels) ServerOptionFunc {
	if len(getLabelSet) == 0 {
		return func(s *InfoServer) {
			s.getLabelSet = func() []labels.Labels { return []labels.Labels{} }
		}
	}
