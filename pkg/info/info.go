...
// the metric metadata information. If no function is provided, the default empty metric
// metadata info is returned. Only the first function from the list is considered.
