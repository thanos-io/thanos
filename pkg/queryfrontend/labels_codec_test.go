...
func TestLabelsCodec_DecodeResponse(t *testing.T) {
	...
	seriesResponse := &ThanosSeriesResponse{
		Status: "success",
		Data:   labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{{Labels: []labelpb.ZLabel{{Name: "foo", Value: "bar"}}}}),
	}
...
func TestLabelsCodec_MergeResponse(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			responses: []queryrange.Response{
				&ThanosSeriesResponse{Status: "success", Data: labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{{Labels: []labelpb.ZLabel{{Name: "foo", Value: "bar"}}}})},
			},
			expectedResponse: &ThanosSeriesResponse{Status: "success", Data: labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{{Labels: []labelpb.ZLabel{{Name: "foo", Value: "bar"}}}})},
		},
		{
		...
		},
		{
			...
			responses: []queryrange.Response{
				&ThanosSeriesResponse{Status: "success", Data: labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{
			...
			expectedResponse: &ThanosSeriesResponse{Status: "success", Data: labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{
				{Labels: []labelpb.ZLabel{{Name: "foo", Value: "aaa"}}},
				{Labels: []labelpb.ZLabel{{Name: "foo", Value: "bar"}}},
				{Labels: []labelpb.ZLabel{{Name: "test", Value: "aaa"}, {Name: "instance", Value: "localhost:9090"}}},
				{Labels: []labelpb.ZLabel{{Name: "test", Value: "bbb"}, {Name: "instance", Value: "localhost:9091"}}},
	...
	for i := range size {
		...
		seriesResp = append(
			...
			&ThanosSeriesResponse{
				Status: "success",
				Data:   labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{{Labels: []labelpb.ZLabel{{Name: fmt.Sprintf("foo-%d", i), Value: fmt.Sprintf("bar-%d", i)}}}}),
			},
			&ThanosSeriesResponse{
				Status: "success",
				Data:   labelpb.ZLabelSetsToLabelSets([]labelpb.ZLabelSet{{Labels: []labelpb.ZLabel{{Name: fmt.Sprintf("foo-%d", i+1), Value: fmt.Sprintf("bar-%d", i+1)}}}}),
			},
		)
	}
