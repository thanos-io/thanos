...
* The [pnpm](https://pnpm.io/) package manager (version 11 or newer). See the [pnpm installation docs](https://pnpm.io/installation) for setup options.
...
The React UI depends on a large number of [npm](https://www.npmjs.com/) packages. These are not checked in, so you will need to download and install them locally via the pnpm package manager:
