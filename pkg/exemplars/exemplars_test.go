			...
			exemplars: []*exemplarspb.ExemplarData{
				{
					SeriesLabels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "__name__", Value: "test_exemplar_metric_total"},
						&labelpb.Label{Name: "instance", Value: "localhost:8090"},
						&labelpb.Label{Name: "job", Value: "prometheus"},
						&labelpb.Label{Name: "service", Value: "bar"},
					}},
				},
			},
			want: []*exemplarspb.ExemplarData{},
			...
			exemplars: []*exemplarspb.ExemplarData{
				{
					SeriesLabels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						...
						&labelpb.Label{Name: "job", Value: "prometheus"},
						&labelpb.Label{Name: "service", Value: "bar"},
						&labelpb.Label{Name: "replica", Value: "0"},
					}},
					Exemplars: []*exemplarspb.Exemplar{
						{
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "traceID", Value: "EpTxMJ40fUus7aGY"},
							}},
							Value: 19,
							Ts:    1600096955479,
						},
			...
			exemplars: []*exemplarspb.ExemplarData{
				{
					...
					Exemplars: []*exemplarspb.Exemplar{
						...
						{
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "traceID", Value: "foo"},
							}},
							Value: 19,
							Ts:    1600096955470,
						},
				...
				},
				{
					...
					Exemplars: []*exemplarspb.Exemplar{
						{
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "traceID", Value: "bar"},
							}},
							Value: 19,
							Ts:    1600096955579,
						},
						...
						{
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "traceID", Value: "test"},
							}},
							Value: 19,
							Ts:    1600096955479,
						},
