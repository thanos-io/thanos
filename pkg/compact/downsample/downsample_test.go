...
func TestDownsampleNativeHistograms(t *testing.T) {
	// First native histogram then became a float.
	// Increasing/decreasing schemas.
	// NaN.
	// Regular downsampling.
	// Gauge histogram / float histogram conversion.

	t.Run("same series is float and then histogram", func(t *testing.T) {
	})

	t.Run("NH with NaNs", func(t *testing.T) {})

	t.Run("NH downsampling with NaNs", func(t *testing.T) {})
