...
func (m *QueryRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ReplicaLabels) > 0 {
		for iNdEx := len(m.ReplicaLabels) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.ReplicaLabels[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if m.MaxResolutionSeconds != 0 {
		i = encodeVarint(dAtA, i, uint64(m.MaxResolutionSeconds))
		i--
		dAtA[i] = 0x20
	}
	...
	if m.TimeSeconds != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TimeSeconds))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Query) > 0 {
...
func (m *QueryResponse_Warnings) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	i = encodeVarint(dAtA, i, uint64(len(m.Warnings)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *QueryResponse_Timeseries) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Timeseries != nil {
		if marshalto, ok := interface{}(m.Timeseries).(interface {
...
func (m *QueryRangeRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.IntervalSeconds != 0 {
		i = encodeVarint(dAtA, i, uint64(m.IntervalSeconds))
		i--
		dAtA[i] = 0x20
	}
	if m.EndTimeSeconds != 0 {
		i = encodeVarint(dAtA, i, uint64(m.EndTimeSeconds))
		i--
		dAtA[i] = 0x18
	}
	if m.StartTimeSeconds != 0 {
		i = encodeVarint(dAtA, i, uint64(m.StartTimeSeconds))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Query) > 0 {
...
func (m *QueryRequest) SizeVT() (n int) {
	...
	if m.TimeSeconds != 0 {
		n += 1 + sov(uint64(m.TimeSeconds))
	}
	if m.TimeoutSeconds != 0 {
		n += 1 + sov(uint64(m.TimeoutSeconds))
	}
	if m.MaxResolutionSeconds != 0 {
		n += 1 + sov(uint64(m.MaxResolutionSeconds))
	}
	if len(m.ReplicaLabels) > 0 {
...
func (m *QueryRangeRequest) SizeVT() (n int) {
	...
	if m.StartTimeSeconds != 0 {
		n += 1 + sov(uint64(m.StartTimeSeconds))
	}
	if m.EndTimeSeconds != 0 {
		n += 1 + sov(uint64(m.EndTimeSeconds))
	}
	if m.IntervalSeconds != 0 {
		n += 1 + sov(uint64(m.IntervalSeconds))
	}
	if m.TimeoutSeconds != 0 {
		n += 1 + sov(uint64(m.TimeoutSeconds))
	}
