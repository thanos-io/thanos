...
// timestampToTimePtr converts a *timestamppb.Timestamp to *time.Time.
...
func TestRulesHandler(t *testing.T) {
	...
	expectedAll := []testpromcompatibility.Rule{
			...
			Alerts: []*testpromcompatibility.Alert{
				{
					...
					ActiveAt:                timestampToTimePtr(all[2].GetAlert().Alerts[0].ActiveAt),
				...
				},
				{
					...
					ActiveAt:                timestampToTimePtr(all[2].GetAlert().Alerts[1].ActiveAt),
		...
		testpromcompatibility.AlertingRule{
			...
			Labels:         labelpb.LabelsToPromLabels(all[4].GetAlert().Labels.Labels),
			Health:         rules.RuleHealth(all[2].GetAlert().Health),
