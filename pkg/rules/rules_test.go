	...
	for _, tc := range []struct {
		...
		},
		{
			...
			want: []*rulespb.Rule{
				...
				rulespb.NewRecordingRule(&rulespb.RecordingRule{
					Name: "a1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "a", Value: "1"},
					}}}),
				rulespb.NewRecordingRule(&rulespb.RecordingRule{
					Name:  "a1",
		...
		},
		{
			...
			want: []*rulespb.Rule{
				...
				rulespb.NewRecordingRule(&rulespb.RecordingRule{
					Name: "a1", Query: "up", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "a", Value: "1"},
					}}}),
			},
		},
		{
			...
			rules: []*rulespb.Rule{
				rulespb.NewAlertingRule(&rulespb.Alert{
					...
					Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "a", Value: "1"},
						&labelpb.Label{Name: "replica", Value: "1"},
					}}}),
				rulespb.NewAlertingRule(&rulespb.Alert{
					Name:            "a1",
					Query:           "up",
		...
		},
		{
			name: "replica labels",
			rules: []*rulespb.Rule{
				rulespb.NewRecordingRule(&rulespb.RecordingRule{Name: "a1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
					&labelpb.Label{Name: "a", Value: "1"},
					&labelpb.Label{Name: "replica", Value: "3"},
				}}}),
				rulespb.NewRecordingRule(&rulespb.RecordingRule{Name: "a1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
					&labelpb.Label{Name: "a", Value: "1"},
					&labelpb.Label{Name: "replica", Value: "1"},
				...
				rulespb.NewRecordingRule(&rulespb.RecordingRule{Name: "a1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
					&labelpb.Label{Name: "a", Value: "1"},
					&labelpb.Label{Name: "replica", Value: "2"},
				}}}),
			},
			want: []*rulespb.Rule{
				rulespb.NewRecordingRule(&rulespb.RecordingRule{Name: "a1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
		...
		},
		{
			...
			rules: []*rulespb.Rule{
				...
				rulespb.NewAlertingRule(&rulespb.Alert{
					...
					Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "replica", Value: "2"},
						&labelpb.Label{Name: "foo", Value: "bar"},
					}},
					LastEvaluation: timestamppb.New(time.Unix(2, 0)),
				}),
				rulespb.NewAlertingRule(&rulespb.Alert{
		...
		},
		{
			...
			rules: []*rulespb.Rule{
				rulespb.NewAlertingRule(&rulespb.Alert{
					...
					Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "replica", Value: "1"},
						&labelpb.Label{Name: "severity", Value: "warning"},
					}},
					LastEvaluation: timestamppb.New(time.Unix(1, 0)),
				}),
				rulespb.NewAlertingRule(&rulespb.Alert{
					...
					Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "replica", Value: "1"},
						&labelpb.Label{Name: "severity", Value: "critical"},
					}},
					LastEvaluation: timestamppb.New(time.Unix(1, 0)),
				}),
				rulespb.NewAlertingRule(&rulespb.Alert{
		...
		},
		{
			...
			rules: []*rulespb.Rule{
				rulespb.NewAlertingRule(&rulespb.Alert{
					...
					Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
						&labelpb.Label{Name: "replica", Value: "1"},
						&labelpb.Label{Name: "label", Value: "foo"},
					}},
					LastEvaluation: timestamppb.New(time.Unix(1, 0)),
				}),
				rulespb.NewAlertingRule(&rulespb.Alert{
...
func TestFilterRules(t *testing.T) {
	for _, tc := range []struct {
			...
			groups: []*rulespb.RuleGroup{
				{
					...
					Rules: []*rulespb.Rule{
						...
						rulespb.NewRecordingRule(&rulespb.RecordingRule{
							Name: "r1", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "label", Value: "foo"},
							}},
						}),
						rulespb.NewRecordingRule(&rulespb.RecordingRule{
							Name: "r2", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "otherlabel", Value: "bar"},
							}},
						}),
					},
				},
			...
			groups: []*rulespb.RuleGroup{
				{
					...
					Rules: []*rulespb.Rule{
						rulespb.NewAlertingRule(&rulespb.Alert{
							...
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "label", Value: "foo"},
								&labelpb.Label{Name: "templatedlabel", Value: "{{ $externalURL }}"},
							}},
						}),
						rulespb.NewAlertingRule(&rulespb.Alert{
							Name: "a2",
			...
			groups: []*rulespb.RuleGroup{
				{
					...
					Rules: []*rulespb.Rule{
						...
						rulespb.NewRecordingRule(&rulespb.RecordingRule{
							Name: "r1a", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "label", Value: "foo"},
							}},
						}),
						rulespb.NewRecordingRule(&rulespb.RecordingRule{
							Name: "r1b", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "otherlabel", Value: "bar"},
							}},
						}),
					},
				},
				{
					...
					Rules: []*rulespb.Rule{
						rulespb.NewAlertingRule(&rulespb.Alert{
							Name: "a1b",
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "some", Value: "label"},
							}},
						}),
						rulespb.NewRecordingRule(&rulespb.RecordingRule{
							Name: "r1b", Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
				...
				},
				{
					...
					Rules: []*rulespb.Rule{
						rulespb.NewAlertingRule(&rulespb.Alert{
							Name: "a1b",
							Labels: &labelpb.LabelSet{Labels: []*labelpb.Label{
								&labelpb.Label{Name: "templated", Value: "{{ $externalURL }}"},
							}},
						}),
					},
				},
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			testutil.Equals(t, tc.want, groups)
		})
	}
}
