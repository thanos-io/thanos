...
func (s *chunkedSeriesSet) At() (prom_labels.Labels, []storepb.AggrChunk) {
...
func TestOverlapSplitSet(t *testing.T) {
	input := []chunkedSeries{
		{
			lset: prom_labels.Labels{{Name: "a", Value: "1_empty"}},
		},
		{
			lset:   prom_labels.Labels{{Name: "a", Value: "2_nonoverlap"}},
			chunks: []storepb.AggrChunk{{MinTime: 0, MaxTime: 20}, {MinTime: 21, MaxTime: 100}, {MinTime: 110, MaxTime: 300}},
		},
		{
			lset:   prom_labels.Labels{{Name: "a", Value: "3_tworeplicas"}},
		...
		{
			lset:   prom_labels.Labels{{Name: "a", Value: "4_nonoverlap"}},
			chunks: []storepb.AggrChunk{{MinTime: 50, MaxTime: 55}, {MinTime: 56, MaxTime: 100}},
		},
		{
			lset:   prom_labels.Labels{{Name: "a", Value: "5_minimaloverlap"}},
			chunks: []storepb.AggrChunk{{MinTime: 50, MaxTime: 55}, {MinTime: 55, MaxTime: 100}},
		},
		{
			lset: prom_labels.Labels{{Name: "a", Value: "6_fourreplica"}},
