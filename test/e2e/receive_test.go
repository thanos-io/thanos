...
func TestReceive(t *testing.T) {
	...
	t.Run("receive_distributor_ingestor_mode", func(t *testing.T) {
		...
		// Setup 1 distributor
		d1, err := e2ethanos.NewReceiverWithDistributorMode(s.SharedDir(), s.NetworkName(), "d1", 1, h)
		testutil.Ok(t, err)
		...
		q, err := e2ethanos.NewQuerier(s.SharedDir(), "1", []string{i1.GRPCNetworkEndpoint(), i2.GRPCNetworkEndpoint(), i3.GRPCNetworkEndpoint()}, nil, nil, nil, nil, nil, "", "")
		testutil.Ok(t, err)
