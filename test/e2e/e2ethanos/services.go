...
func (r *RulerBuilder) InitTSDB(internalRuleDir string, queryCfg []queryconfig.Config) *e2eobs.Observable {
	return r.initRule(internalRuleDir, queryCfg, nil)
}

func (r *RulerBuilder) InitStateless(internalRuleDir string, queryCfg []queryconfig.Config, remoteWriteCfg []*config.RemoteWriteConfig) *e2eobs.Observable {
	return r.initRule(internalRuleDir, queryCfg, remoteWriteCfg)
}

func (r *RulerBuilder) initRule(internalRuleDir string, queryCfg []queryconfig.Config, remoteWriteCfg []*config.RemoteWriteConfig) *e2eobs.Observable {
