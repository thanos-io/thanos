...
func NewQuerier(sharedDir, name string, storeAddresses, fileSDStoreAddresses, ruleAddresses, exemplarAddresses []string, routePrefix, externalPrefix string) (*Service, error) {
