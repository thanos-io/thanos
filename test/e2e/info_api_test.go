...
func TestInfo(t *testing.T) {
	...
	prom1, sidecar1, err := e2ethanos.NewPrometheusWithSidecar(e, "alone1", e2ethanos.DefaultPromConfig("prom-alone1", 0, "", "", false), "", e2ethanos.DefaultPrometheusImage(), "")
	testutil.Ok(t, err)
	prom2, sidecar2, err := e2ethanos.NewPrometheusWithSidecar(e, "alone2", e2ethanos.DefaultPromConfig("prom-alone2", 0, "", "", false), "", e2ethanos.DefaultPrometheusImage(), "")
	testutil.Ok(t, err)
	prom3, sidecar3, err := e2ethanos.NewPrometheusWithSidecar(e, "alone3", e2ethanos.DefaultPromConfig("prom-alone3", 0, "", "", false), "", e2ethanos.DefaultPrometheusImage(), "")
	testutil.Ok(t, err)
